    ...
    data(){
      return{
        ...
        columns: [{
          ...
          // {
          //   field: '', title: '序号', width: 40, titleAlign: 'center', columnAlign: 'center',
          ...
          {
            field: 'calculations', title: '结果', width: 60, titleAlign: 'center', columnAlign: 'center',
            formatter: function (rowData,rowIndex,pagingIndex,field) {
          ...
          {
            field: 'custome-adv', title: '操作',width: 130, titleAlign: 'center',columnAlign:'center',componentName:'table-operation',isResize:true
          // {
    ...
    methods:{
      ...
      customCompFunc(params){
          ...
          if (params.type === 'delete'){ // do delete operation
              ...
              alert(`行号：${params.index} 结果：${params.rowData['calculations']}`)
          }
      },
      // 单元格样式
      columnCellClass(rowIndex,columnName,rowData){
          // 给三行column为‘hobby’的列设置className
          if (rowIndex === 1 && columnName==='content'){
